...
namespace Business
{
    internal class Builder_Business
    {
        ...
        public string GetBusinessClass(Model.CodeCreate param)
        {
            ...
            business.Append("namespace " + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Business + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "\r\n");
            business.Append("{\r\n");
            ...
            if (param.MethodList.Contains(Model.BuilderMethods.Add))
            {
                ...
                business.Append("\t\t/// 新增\r\n");
                business.Append("\t\t/// </summary>\r\n");
                business.Append("\t\tpublic " + (HasIdentity ? Identitys.First().DotNetType : "int") + " Add(" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + " model)\r\n");
                business.Append("\t\t{\r\n");
            ...
            if (param.MethodList.Contains(Model.BuilderMethods.Update) && HasPrimarykey)
            {
                ...
                business.Append("\t\t/// 更新\r\n");
                business.Append("\t\t/// </summary>\r\n");
                business.Append("\t\tpublic int Update(" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + " model)\r\n");
                business.Append("\t\t{\r\n");
            ...
            if (param.MethodList.Contains(Model.BuilderMethods.SelectAll))
            {
                ...
                business.Append("\t\t/// </summary>\r\n");
                business.Append("\t\tpublic List<" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + "> GetAll()\r\n");
                business.Append("\t\t{\r\n");
            ...
            if (param.MethodList.Contains(Model.BuilderMethods.SelectByKey) && HasPrimarykey)
            {
                ...
                business.Append("\t\t/// </summary>\r\n");
                business.Append("\t\tpublic " + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + " Get(");
