...
namespace Business
{
    internal class Builder_Data
    {
        ...
        public string GetDataClass(Model.CodeCreate param)
        {
            ...
            data.Append("namespace " + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Data + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "\r\n");
            data.Append("{\r\n");
            data.Append("\tpublic class " + param.ClassName + (param.BuilderType == Model.BuilderType.Factory ? " : " + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Interface + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + ".I" + param.ClassName : "") + "\r\n");
            data.Append("\t{\r\n");
        ...
        private string GetAddMethod(List<Model.Fields> fields, Model.CodeCreate param)
        {
            ...
            data.Append("\t\t/// 添加记录\r\n");
            data.Append("\t\t/// </summary>\r\n");
            data.Append("\t\t/// <param name=\"model\">" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + "实体类</param>\r\n");
            data.Append("\t\t/// <returns>" + (HasIdentity ? "新增记录的ID" : "操作所影响的行数") + "</returns>\r\n");
            data.Append("\t\tpublic " + (HasIdentity ? Identitys.First().DotNetType : "int") + " Add(" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + " model)\r\n");
            data.Append("\t\t{\r\n");
        ...
        private string GetUpdateMethod(List<Model.Fields> fields, Model.CodeCreate param)
        {
            ...
            data.Append("\t\t/// </summary>\r\n");
            data.Append("\t\t/// <param name=\"model\">" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + "实体类</param>\r\n");
            data.Append("\t\tpublic int Update(" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + " model)\r\n");
            data.Append("\t\t{\r\n");
        ...
        private string GetConvertDataReaderToListMethod(List<Model.Fields> fields, Model.CodeCreate param)
        {
            ...
            data.Append("\t\t/// </summary>\r\n");
            data.Append("\t\tprivate List<" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + "> DataReaderToList(" + createInstance.GetDataReaderType() + " dataReader)\r\n");
            data.Append("\t\t{\r\n");
            data.Append("\t\t\tList<" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + "> List = new List<" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + ">();\r\n");
            data.Append("\t\t\t" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + " model = null;\r\n");
            data.Append("\t\t\twhile(dataReader.Read())\r\n");
            data.Append("\t\t\t{\r\n");

            data.Append("\t\t\t\tmodel = new " + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + "();\r\n");
            int i = 0;
        ...
        private string GetAllMethod(List<Model.Fields> fields, Model.CodeCreate param)
        {
            ...
            data.Append("\t\t/// 查询所有记录\r\n");
            data.Append("\t\t/// </summary>\r\n");
            data.Append("\t\tpublic List<" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + "> GetAll()\r\n");
            data.Append("\t\t{\r\n");
            ...
            data.Append("\t\t\tList<" + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + "> List = DataReaderToList(dataReader);\r\n");
        ...
        private string GetByKeyMethod(List<Model.Fields> fields, Model.CodeCreate param)
        {
            ...
            data.Append("\t\t/// </summary>\r\n");
            data.Append("\t\tpublic " + param.NameSpace + (param.NameSpace == null ? "" : ".") + param.CNSC.Model + (param.NameSpace1 == null ? "" : "." + param.NameSpace1) + "." + param.ClassName + " Get(");
            foreach (var field in Primarykeys)
            {
                data.Append(field.DotNetType + " " + field.Name.ToLower());
                data.Append(field.Name != Primarykeys.Last().Name ? ", " : "");
