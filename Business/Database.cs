...
namespace Business
{
    public class Database
    {
        ...
        /// <param name="errMessage">错误信息</param>
        /// <returns></returns>
        public bool _TestDatabaseConnnection(string serverID, out string errMessage)
        {
        ...
        {
            return GetDatabaseList(serverID);
        }
        /// <summary>
        /// 得到数据库所有表
        /// </summary>
        ...
        public static DataTable GetDataTable(string sql, string serverID, string dbName)
        {
        ...
        /// <returns></returns>
        private static bool IsPrimaryKey(string serverID, string dbName, string tableName, string fieldName)
        {
            using (SqlConnection conn = new SqlConnection(Config.GetConnectionString(serverID, dbName)))
            {
                conn.Open();
        ...
        /// <param name="filedName"></param>
        /// <returns></returns>
        private static bool IsIdentity(string serverID, string dbName, string tableName, string fieldName)
        {
            using (SqlConnection conn = new SqlConnection(Config.GetConnectionString(serverID, dbName)))
            {
                conn.Open();
        ...
        /// <param name="filedName"></param>
        /// <returns></returns>
        private static string GetFieldNote(string serverID, string dbName, string tableName, string fieldName)
        {
            using (SqlConnection conn = new SqlConnection(Config.GetConnectionString(serverID, dbName)))
            {
                conn.Open();
        ...
        /// <returns></returns>
        private static string GetFieldType(string typeName, bool isNull)
        {
        ...
        /// <returns></returns>
        public static string GetFieldSqlType(string typeName)
        {
            string r = string.Empty;
        ...
        /// <returns></returns>
        private static int GetFieldLength(string typeName, int length)
        {
            int r = -1;
            switch (typeName)
            {
